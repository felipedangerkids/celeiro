...
@section('content')
    <div class="container">
        ...
        <div class="text-center mt-4">
            <button class="btn btn-american-ipa_">Morcela</button>
            <button class="btn btn-american-ibv">Linguiça</button>
        </div>
                ...
                <div class="row">
                    <div class="product_ col-5">
                        <a href="/produto-single">
                            <img src="{{ url('assets/img/morcela.png') }}" alt="">
                        </a>
                        <div class="caption">
                            <span>Morcela </span>
                        </div>
                    ...
                    <div class="product_ col-5  mb-5">
                        <a class="/produto-single">
                            <img src="{{ url('assets/img/morcela1.png') }}" alt="">
                        </a>
                        <div class="caption">
                            <span>Cracóvia</span>
                        </div>
